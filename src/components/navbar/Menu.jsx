      ...
      >
        ...
        >
          <div className="menu-item relative border-t-1 border-b-1 border-gray-500 w-full text-center pt-7 ">
            ...
            <div
              ref={marqueeRef}
              className="marquee absolute top-0  w-full h-full bg-[#d2fd50] text-black overflow-hidden"
            >
          ...
          <div className="menu-item relative border-t border-b border-gray-500 w-full text-center pt-7">
            ...
            <div
              ref={marqueeRef}
              className="marquee absolute top-0 left-0 w-full h-full bg-[#d2fd50] text-black overflow-hidden"
            >
              <div className="moveX flex gap-10 uppercase items-center leading-[7vw]">
                {/* Set 1 */}
...
//     // Attach hover events to each item
//     items.forEach((item) => {
...
//       >
//         {/* PROJETS */}
//         <div className="menu-item relative border-t border-b border-gray-500 w-full text-center pt-7 cursor-pointer">
//           PROJETS
//           <div className="marquee absolute top-0 left-0 w-full h-full bg-[#d2fd50] text-black overflow-hidden transform -translate-y-full opacity-0">
//             <div className="moveX flex gap-10 uppercase items-center leading-[7vw]">
//               <h2>Pour tout voir</h2>
//               <img
//                 src="https://k72.ca/uploads/caseStudies/PJC/Thumbnails/PJC_SiteK72_Thumbnail_640x290-640x290.jpg"
...
//               <h2>Lire plus</h2>
//               <img
//                 src="https://images.unsplash.com/photo-1700405084579-d093cb3adb80?q=80&w=1228&auto=format&fit=crop"
//                 alt="blogue-img"
//                 className="h-29 w-70 shrink-0 rounded-full object-cover"
//               />
//               <h2>Lire plus</h2>
//               <img
//                 src="https://images.unsplash.com/photo-1724097407273-67c9d4d4f590?q=80&w=1170&auto=format&fit=crop"
//                 alt="blogue-img-2"
//                 className="h-29 w-70 shrink-0 rounded-full object-cover"
//               />
//             </div>
